        ...
        for (RMNCHMBeneficiaryaddress a : addressList) {
            ...
            try {
                ...
                if (m != null) {
                    ...
                    System.out.println("BenId:"+m.getBenRegId());
                    Map<String, Object> benVisitthDetails = getBenBenVisitDetails(m.getBenRegId());
...
//                    benDetailsRMNCH_OBJ.setRegistrationDate(benDetailsOBJ.getCreatedDate());
                    ...
                    if (benHouseHoldRMNCH_ROBJ != null) {
                        ...
                        resultMap.put("benVisitDate", benVisitthDetails);
    ...
    private Map<String, Object> getBenBenVisitDetails(BigInteger benRegId) {
        Map<String, Object> healthDetails = new HashMap<>();
        if (null != benRegId) {
           List< BenVisitDetail> benVisitDetail = benVisitDetailsRepo.findByBeneficiaryRegId(benRegId.longValue());
            if (null != benVisitDetail) {
                for(BenVisitDetail benVisitDetail1 : benVisitDetail){
                    healthDetails.put("HWCVisitDate", benVisitDetail1.getVisitDateTime());
                    healthDetails.put("referredto", benVisitDetail1.getHealthFacilityLocation());
                    healthDetails.put("followUpDate",benVisitDetail1.getVisitDateTime());
                }
                }
