...
public interface BenFlowStatusRepo extends JpaRepository<BenFlowStatus, Long> {
    ...
    @Query("SELECT b FROM BenFlowStatus b WHERE b.providerServiceMapId = :psmId AND b.villageID = :villageId AND b.visitCategory = 'Stop TB' AND b.deleted = false ORDER BY b.registrationDate DESC")
