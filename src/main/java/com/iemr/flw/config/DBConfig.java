...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackages = {"com.iemr.flw.repo", "com.iemr.flw.*"})
...
//		datasource.setPassword(cryptoUtil.decrypt(ConfigProperties.getPropertyByName("encDbPass")));
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.iemr.flw.*", "com.iemr.flw.domain.*").persistenceUnit("db_identity").build();
	}
