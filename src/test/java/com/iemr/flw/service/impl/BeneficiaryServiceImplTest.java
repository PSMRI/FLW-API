...
class BeneficiaryServiceImplTest {
    ...
    void testGetBenData_withValidRequest_success() throws Exception {
        ...
        when(beneficiaryRepo.getByAddressID(address.getId())).thenReturn(Collections.singletonList(mapping));
    ...
    void testGetBenData_relatedBeneficiaryIds_parsing() throws Exception {
        ...
        when(beneficiaryRepo.getDetailsByRegID(mapping.getBenRegId().longValue())).thenReturn(Collections.singletonList(rmnchDetails));
        ...
        when(houseHoldRepo.getByHouseHoldID(rmnchDetails.getHouseoldId())).thenReturn(Collections.singletonList(createTestHouseHoldDetails()));
        setupHealthDetailsMocks();
    ...
    void testGetBenData_nullBenRegId_skipsHealthDetails() throws Exception {
        ...
        when(beneficiaryRepo.getUserName(request.getAshaId())).thenReturn("testUser");
        when(beneficiaryRepo.getBenDataByUser("testUser", pageRequest)).thenReturn(page);
        when(beneficiaryRepo.getByAddressID(address.getId())).thenReturn(Collections.singletonList(nullRegIdMapping));
    ...
    void testGetBenData_partialMappingData_handlesNulls() throws Exception {
        ...
        when(beneficiaryRepo.getUserName(request.getAshaId())).thenReturn("testUser");
        when(beneficiaryRepo.getBenDataByUser("testUser", pageRequest)).thenReturn(page);
        when(beneficiaryRepo.getByAddressID(address.getId())).thenReturn(Collections.singletonList(partialMapping));
        ...
        when(beneficiaryRepo.getDetailsByRegID(partialMapping.getBenRegId().longValue())).thenReturn(Collections.singletonList(createTestRMNCHBeneficiaryDetails()));
    ...
    private void setupMappingDataMocks() {
        ...
        when(houseHoldRepo.getByHouseHoldID(rmnchDetails.getHouseoldId())).thenReturn(Collections.singletonList(houseHold));
